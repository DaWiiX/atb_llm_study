...
原 `atb_cpp_qwen3vl_embedding` → `atb_cpp_llm`
...
│   ├── attention_builder.h           # Attention Builder 接口
│   ├── gqa_attention_builder.cpp     # GQA Builder 实现
│   ├── swiglu_mlp_graph.h/cpp        # SwiGLU MLP (Qwen/Llama/...)
│   ├── mlp_builder.h/cpp             # MLP Builder 接口 + 实现
│   ├── moe_mlp_graph.h               # MoE MLP（预留）
│   ├── rms_norm_graph.h/cpp          # RMSNorm
│   ├── mrope.h/cpp                   # 多维 RoPE（Qwen-VL 系列）
│   ├── rope_1d.h                     # 1D RoPE
│   ├── cross_modal_fusion.h          # 跨模态融合接口
│   └── deepstack_fusion.h/cpp        # Deepstack 融合（IndexAdd 注入）
├── text/                             # 文本专用组件
│   └── decoder_layer_graph.h/cpp     # Text Decoder Layer
└── vision/                           # 视觉专用组件
    ├── vision_attention_graph.h/cpp  # Vision Attention
    ├── vision_block_graph.h/cpp      # ViT Block
    ├── vision_merger_graph.h/cpp     # Vision Merger MLP
    ├── vision_mlp_graph.h/cpp        # Vision MLP (GELU)
    ├── patch_embed_graph.h/cpp       # Patch Embedding
    ├── deepstack_graph.h/cpp         # Deepstack Merger
    ├── pos_embed_interp.h/cpp        # 位置编码插值（CPU）
    ├── pos_embed_npu_graph.h/cpp     # 位置编码（NPU）
    └── vis_rope_npu_graph.h/cpp      # Vision RoPE (NPU)
```
...
```cpp
// src/components/common/moe_mlp_graph.h
class MoEMLPGraph {
public:
    struct Config {
        int hidden_size;
...
│   ├── embedder.h                    # Qwen3VLEmbedder 部署层
│   ├── engine.h                      # LLMEngine 对外接口
│   ├── kv_cache.h                    # KV Cache 管理接口
│   ├── layer_desc.h                  # LayerDescriptor 枚举
│   ├── model.h                       # IModel 接口 + 注册宏
│   ├── operation_handle.h            # OperationHandle RAII
...
│   │   │   ├── mrope.h/cpp
│   │   │   ├── rope_1d.h
│   │   │   ├── cross_modal_fusion.h
│   │   │   └── deepstack_fusion.h/cpp
│   │   ├── text/                     #   文本组件
│   │   │   └── decoder_layer_graph.h/cpp
│   │   └── vision/                   #   视觉组件
│   │       ├── vision_attention_graph.h/cpp
│   │       ├── vision_block_graph.h/cpp
│   │       ├── vision_merger_graph.h/cpp
│   │       ├── vision_mlp_graph.h/cpp
│   │       ├── patch_embed_graph.h/cpp
│   │       ├── deepstack_graph.h/cpp
│   │       ├── pos_embed_interp.h/cpp
│   │       ├── pos_embed_npu_graph.h/cpp
│   │       └── vis_rope_npu_graph.h/cpp
│   │
│   ├── runners/                      # 图生命周期管理
│   │   ├── text_runner.h/cpp
│   │   └── vision_runner.h/cpp
...
project(atb_cpp_llm LANGUAGES CXX)
